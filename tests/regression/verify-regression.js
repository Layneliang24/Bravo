...
class RegressionVerifier {
  ...
  async checkDependencies() {
    ...
    if (!packageJson) {
      throw new Error(
        `未找到package.json文件，尝试的路径: ${possiblePaths.join(", ")}`,
      );
    }
    ...
    const otherPaths = [
      ...
      {
        path: path.join(this.projectRoot, "e2e/package.json"),
        name: "E2E测试",
      },
    ];
            ...
            ${report.checks
              .map(
                ...
                <div class="check-item ${
                  check.success ? "check-success" : "check-failed"
                }">
