...
| 优先级 | 规则类型                     | 示例                                            |
| ------ | ---------------------------- | ----------------------------------------------- |
| 1000   | V4核心原则                   | v4-core-principles.mdc                          |
| 950    | Pre-commit规则、PRD设计专家  | pre-commit.mdc, prd-designer.mdc                |
| 900    | 架构专家、追溯链规则         | architect.mdc, v4-traceability.mdc              |
| 850    | 测试专家、契约驱动、测试阶段 | tester.mdc, v4-contract-driven.mdc, testing.mdc |
| 800    | 开发专家、任务生成阶段       | developer.mdc, task-generation.mdc              |
| 750    | 开发阶段                     | development.mdc                                 |
| 700    | 任务执行阶段                 | task-execution.mdc                              |
| 650    | CI/CD阶段                    | ci-cd.mdc                                       |
| 600    | Debug阶段                    | debugging.mdc                                   |
| 550    | 部署阶段                     | deployment.mdc                                  |
| 500    | 补充规则                     | supplementary.mdc                               |
...
- `@.cursor/rules/lifecycle/testing.mdc` ✅
...
- **全局宪法**: `.cursorrules`
- **V4核心规则**: `.cursor/rules/v4/v4-core-principles.mdc`
