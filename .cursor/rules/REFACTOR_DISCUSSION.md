...
- `@.cursor/rules/principles/v4-core.mdc` → `@.cursor/rules/principles/v4-core.mdc`
- `@.cursor/rules/workflows/testing.mdc` → `@.cursor/rules/workflows/testing.mdc`
- `@.cursor/rules/workflows/task-execution.mdc` → `@.cursor/rules/workflows/task-execution.mdc`
- `@.cursor/rules/tools/pre-commit.mdc` → `@.cursor/rules/tools/pre-commit.mdc`
