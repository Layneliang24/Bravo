...
const { linkTestToFeature, describeFeature, linkMultipleFeatures } = require('../../matchFeatures');
...
describeFeature('ENG-002', '英语新闻详情页翻译功能', () => {
  ...
  it('should handle translation errors', async () => {
    // 模拟翻译错误处理
    const mockTranslateError = jest.fn().mockRejectedValue(new Error('Translation failed'));
...
describe('错误处理演示', () => {
  ...
  it('should provide helpful error messages', () => {
    // 演示错误信息的有用性
    const errorMessage = 'Invalid feature ID: INVALID-001. Valid IDs: ENG-001, ENG-002, BLOG-001';
